import {BiRightArrowAlt, BiHome, BiCode, BiBriefcase, BiMailSend } from "react-icons/bi"
...
bg-purple-500 text-white backdrop-filter backdrop-blur-sm bg-opacity-70 border border-purple-400">
        <ul className="flex flex-col gap-10">
          ...
          transition-all duration-200 group sm:text-lg md:text-xl xl:text-3xl">
            ...
            <a href={`#${item}`} className="transition-all duration-200 hover:translate-x-2">{item}</a>
          </li>) )}
        </ul>
      </div>

      <div className="fixed left-0 right-0 top-0 z-10 flex 
