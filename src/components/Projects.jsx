  ...
  return (
    ...
    items-center justify-center gap-20 p-10 md:p-16 xl:p-32">
      ...
      gap-5">
        ...
        border-purple-500 rounded-lg hover:bg-purple-100">
          <h1 className="text-3xl font-semibold">Project Name</h1>
          <h3 className="text-xl text-gray-700">Tech Stack</h3>
          <p className="text-sm text-gray-600">Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
            Voluptatibus, doloremque modi! Maxime, voluptatem! 
            Hic quia eligendi numquam odit. 
            Molestias repudiandae debitis neque atque soluta dolorum explicabo repellendus modi quia quod.</p>
